#include "behaviortree_ros2/bt_service_shared_node.hpp"
#include "btcpp_ros2_interfaces/srv/add_two_ints.hpp"

using namespace BT;

class AddTwoIntsClient: public RosServiceSharedNode<btcpp_ros2_interfaces::srv::AddTwoInts, AddTwoIntsClient>
{
public:
  AddTwoIntsClient(const std::string& name,
                  const NodeConfig& conf,
                  const RosNodeParams& params)
    : RosServiceSharedNode<btcpp_ros2_interfaces::srv::AddTwoInts, AddTwoIntsClient>(name, conf, params)
  {}
