...
#ifndef BEHAVIORTREE_ROS2__PLUGINS__CONTROL__PIPELINE_SEQUENCE_HPP_
#define BEHAVIORTREE_ROS2__PLUGINS__CONTROL__PIPELINE_SEQUENCE_HPP_
 ...
 */
class PipelineSequence : public ControlNode
{
public:
  /**
   ...
   */
  PipelineSequence(const std::string & name, const NodeConfig & config);
...
#endif  // BEHAVIORTREE_ROS2__PLUGINS__CONTROL__PIPELINE_SEQUENCE_HPP_
