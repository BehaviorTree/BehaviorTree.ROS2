...
class BtActionNode : public ActionNodeBase
{
public:
  /**
  ...
  : ActionNodeBase(xml_tag_name, conf), action_name_(action_name)
  {
   ...
   * @return NodeStatus Returns SUCCESS by default, user may override return another value
   */
  virtual NodeStatus on_cancelled()
  {
    return NodeStatus::SUCCESS;
  }
